...
* ミリシタのアイドルの体型を主成分分析して、特異的な体型のアイドルを探してみましたが、よくネタにされる千早や風花はそれほど特異的ではないことが分かりました。一方で、可憐、翼、静香はかなり特異的な体型であることが分かりました。数学の力で今まで見えなかったことが見えるようになるのは素晴らしいですね。
* 年齢による成長度を考慮することで、年齢差のあるアイドルの体型比較も可能になりました。すると、育や桃子が将来どんな(体型の)アイドルになりそうなのかが見えてきました。もちろん可能性のひとつにすぎませんが、夢が広がります。
